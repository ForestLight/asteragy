...
public abstract class AsterClass {
	...
	public final static String[] commandName = { "クラスチェンジ", "スワップ", "クイックタイム",
			...
			"ロングレンジスワップ", "ソニックムーブ", "クルーエルルイン", "トータルイクリプス", };
	...
	public final static int[] classCost = { 0, 2, 6, 5, 4, 8, 7, 10, 10, 11,
			12, 0 };

	public final static int[] commandCost = { 0, 0, 4, 7, 4, 4, 1, 4, 5, 3, 18,
			4 };
